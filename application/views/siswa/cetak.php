...
<html>
  ...
  <body onload="window.print();">
    ...
    <div style="float:right;">
      ...
      <b><u>Zafrullah A. Rahman, MA</u></b><br>
      NIP. 
    </div>
    ...
    <table width="100%" border="0" style="margin-left:5px;">
      ...
      <tr>
        <td>3.</td>
        <td>Fotocopy Ijazah TK / PAUD (Jika ada)</td>
        <td>:</td>
        <td>1 lembar</td>
      </tr>
      <tr>
      ...
      <tr>
        <td valign="top">7.</td>
        <td colspan="3">Semua berkas dimasukan kedalam map plastik berlubang (Contoh:  merk folder one), laki – laki warna biru dan perempuan warna merah</td>
      </tr>
    </table>
