...
<html>
  ...
  <body onload="window.print();">
    ...
    <h4 align="center" style="margin:0px;font-size:19px;"><u><b>S U R A T  P E N G U M U M A N</b></u></h4>
      <center>
        No : &nbsp;&nbsp; /&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/PPDB.SDITALQUDWAH/<?php echo $thn_ppdb; ?>
      </center>

    <br>
    <table width="100%" border="0">
      <tr>
        <td colspan="3">Kepala SDIT AL-QUDWAH PEKANBARU dengan ini menyatakan bahwa :</td>
      </tr>
      <tr>
    ...
    Seleksi Sebagai Calon Peserta Didik SDIT AL-QUDWAH tahun ajaran <?php echo $thn_ppdb; ?>/<?php echo $thn_ppdb+1; ?>.<br>
    ...
    <div style="float:right;">
      ...
      <br>
      <center>dto</center>
      <b><u>Rifqy Azka Zhofary, M.Pd</u></b><br>
      NIP. 
    </div>
    <br><br><br><br><br><br>
