			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="upload/foto/<?= ucwords($pas_foto)?>" class="img-circle img-sm" alt="foto">
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_siswa/biodata" class="media-left"><img src="upload/foto/<?= ucwords($pas_foto)?>" class="img-circle img-sm" alt="foto"></a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li class="<?php if($menu == 'panel_siswa' AND $sub_menu == 'biodata'){echo 'active';} ?>"><a href="panel_siswa/biodata"><i class="icon-file-check2"></i> <span>Biodata</span></a></li>
