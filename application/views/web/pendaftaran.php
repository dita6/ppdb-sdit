...
<head>
    ...
    <title>PPDB SDIT AL-QUDWAH</title>
    ...
    <section>
      ...
      <div>
        ...
        <div class="header" style="margin-top:-20px; text-align: center;">
                    ...
                    <h2 align="center">FORM PENDAFTARAN PPDB ONLINE <strong> <br>SDIT AL-QUDWAH</strong></h2>
                        ...
                        <fieldset>
                           ...
                           <div class="form-group" >
                              ...
                              <span style="font-size:15px">
                                 Proses PPDB Online SDIT AL-QUDWAH hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                 <br><br>
                                 <div class="col-md-12" >
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>Copyright &copy; <a href="http://www.sman1belitang.sch.id" target="_blank">SDIT AL-QUDWAH</a> <?php echo date('Y'); ?> | IT Development</span>
              </p>
